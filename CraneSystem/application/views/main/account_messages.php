                    ...
                    <div class="row">
                        <div class="col-12">
                           <div class="card m-b-20">
                              ...
                              <div class="card-body">
                                  <?php if($row->type_account=='Person'){?>
                                   <form action="<?php echo base_url('Projects/Send_Messagep/'.$this->uri->segment(3)) ?>" method="post">
                                  <?php }else{?>
                                    <form action="<?php echo base_url('Projects/Send_Message/'.$this->uri->segment(3)) ?>" method="post">
                                    <?php }?>
