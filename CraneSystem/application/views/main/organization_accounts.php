...
margin-top: 106px;">
    <div class="col-sm-12">
       ...
       <li class="breadcrumb-item active">Organizations</li></ol>
...
<div class="page-content-wrapper"  >
    ...
    <div class="row">
        <div class="col-12">
          ...
          <?php  //`account_id`, `register_date`,  `organization`, `activity`, `country`, `contact_number`, `looking`, `profile_url ?>
                                <?php 
                                if($result):
                                foreach ($result as $row): ?>
                       <tr>
                          <?php if($row->profile_url!=NULL){?>
                          <td><a href="<?php echo $row->profile_url;?>" target="_blank" title="LinkedIn URL"><?php echo $row->organization; ?></a></td>
                               <?php }else{?><td><strong><?php echo $row->organization; ?></strong></td> <?php }?>
																								...
																								<div class="modal-dialog modal-lg">
																									<div class="modal-content modeldelete">
																										...
																										<div class="modal-body modelbodydelete">
																											<p>This  <strong><?php echo $row->organization; ?></strong> will be delete, Contiue?</p>
																							
																										</div>
                                                                                               	<div class="modal-footer">
																									<a  href="<?php echo base_url('Accounts/Delete_AccountOrg/'.$row->account_id) ?>" class="btn btn-danger">Delete</a>
                                                                                            ...
                                                                                            <div class="modal fade block<?php echo $row->account_id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
																								<div class="modal-dialog modal-lg">
																									<div class="modal-content modeldelete">
																										...
																										<div class="modal-body modelbodydelete">
																											<p>This <strong><?php echo $row->organization; ?></strong> will be block, Contiue?</p>
																							
																										</div>
                                                                                               	<div class="modal-footer">
																									<a  href="<?php echo base_url('Accounts/Block_AccountOrg/'.$row->account_id) ?>" class="btn btn-danger">Block</a>
																									<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
																								</div>
																									</div>
																									<!-- /.modal-content -->
                                                                                               ...
                                                                                               <div class="modal fade unblock<?php echo $row->account_id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
																								<div class="modal-dialog modal-lg">
																									<div class="modal-content modeldelete">
																										...
																										<div class="modal-body modelbodydelete">
																											<p>This <strong><?php echo $row->organization; ?></strong> will be unblock, Contiue?</p>
																							
																										</div>
                                                                                               	<div class="modal-footer">
																									<a  href="<?php echo base_url('Accounts/Unblock_AccountOrg/'.$row->account_id) ?>" class="btn btn-info">Unblock</a>
																									<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
																								</div>
																									</div>
																									<!-- /.modal-content -->
