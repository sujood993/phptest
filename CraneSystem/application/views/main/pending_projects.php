...
margin-top: 106px;">
    <div class="col-sm-12">
       ...
       <li class="breadcrumb-item active">Pending Projects</li></ol>
                 ...
                 <table id="datatable-buttons" class="        table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                       ...
                       <tr>
                          ...
                          <td style="text-align: center;"><a href="<?php echo base_url('Projects/Project_details/'.$row->project_id) ?>" class="btn btn-info white" title="View"> <i class="ion-eye"></i></a> <a href="<?php echo base_url('Projects/Approve_Project/'.$row->project_id.'/'.$row->account_id) ?>" class="btn btn-success   white" title="Approve"> <i class="ion-android-checkmark"></i></a>   <a class="btn btn-danger white" data-toggle="modal" data-target=".delete<?php echo $row->project_id ?>" title="Delete"> <i class="ion-android-trash"></i></a>  </td>
                       </tr>
