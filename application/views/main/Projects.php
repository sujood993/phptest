    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="sidebar-title"><h2>Existing Projects</h2></div>
                      <?php if (isset($error)) { ?>
    <p style="text-align: center;    font-size: 36px;"><br /><br /> <!--The login email is already registered/ Email or password is inccoorect echo your error & success messages here -->
        <span class="error-message">
No result found <span class="icon fa fa-search"></span>
       </span>
    </p>
    <?php } ?>
                                                  <?php if ($result): ?> 
        ...
        $row->date; ?></div>
                                        ...
                                        <?php if ($row->type_account ==
        "Organization") { ?>
                                          <li style="display: none;">By: <?php echo
$row->organization; ?></li>                                        
                                       <?php } else { ?>                                                                                
                                            <li style="display: none;"> By: <?php echo
$row->fname;
        ...
        project_name; ?></a></h3>
<p style="text-justify: auto;"><?php echo $row->brif_desc; ?></p>
...
$row->project_id) ?>" class="theme-btn btn-style-two read-more">Read more</a>
        ...
        $row->project_id) ?>" class="theme-btn btn-style-one join-project">Join Project</a>
                                    </div>
                                </div>
                            </div>
                        </div>
