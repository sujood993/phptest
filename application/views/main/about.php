                ...
                <div class="sidebar-side col-lg-3 col-md-4 col-sm-12 col-xs-12">
                	<aside class="sidebar default-sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <div class="image">
                            	<img src="<?php echo base_url('public/images/about/1.jpg') ?>" style="height: 250px;" />
                            </div><br />
                        <ul class="blog-cat">
                                <li class="active" ><a   href="<?php echo
base_url('Maincontroller/About') ?>">Who We Are</a></li>
...
base_url('Maincontroller/Overview') ?>">Crane Overview</a></li>
                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                	<div class="company-single">
						<div class="inner-box">
                            <h3>Let's Know More About <span class="orange">CRANE</span></h3>
                            <div class="text">
                           <?php if ($result): ?> 
                                           ...
                                           <?php echo $row->content_page; ?>
                                                         <?php endforeach; ?>
                             <?php endif; ?>
                            <p><strong>CEO : Ruba Al khateeb</strong> </p>
                            </div>
                        </div>
                    </div>
                </div>
