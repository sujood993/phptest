    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="sidebar-title"><h2>Join Project</h2></div>
                        <!--Comments Area-->
                        ...
                        <div class="comment-form">
                            <div class="form-inner">
                                <!--Comment Form-->
                                <form method="post" action="<?php echo base_url('Projects/Join_Project/' .
$project_id); ?>" enctype="multipart/form-data" method="POST">
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                            <label><span style="color:red">*</span>Project name You Will Join:</label><br />
                                            <input type="text" value="<?php echo
$project_name ?>" name="project_name" required="" class="read-only" readonly="" />
                                        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
...
<option value="Others">Others</option>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                 <input class="theme-btn btn-style-two" type="submit" name="save" value="Join Project"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
