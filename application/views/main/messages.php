    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="sidebar-title"><h2>Your Messages | <span style="color: #da7928;">Inbox</span>
                 </h2> <span style="    float: right;
    margin-right: -100px;"><a href="<?php echo base_url('Accounts/Messages') ?>" class="theme-btn btn-style-two btnemail" style="width: 23%;">Inbox</a>
                 <a href="<?php echo base_url('Accounts/MessagesSent') ?>" class="theme-btn btn-style-two btnemail " style="width: 23%;">Sent</a>
...
msg_id ?>').style.display='none'" 
      ...
      <div class="w3-container">
        ...
        <a href="<?php echo base_url('Accounts/delete_Msgr/'.$row->
