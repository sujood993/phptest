                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12" style="float: right!important;">
                	<div class="blog-single padding-right">
                            ...
                            <div class="inner-box">
                                <div class="lower-content">
                                    <div class="upper-box clearfix">
                                        <div class="posted-date pull-left"><?php echo $row->message_date_time ?></div>
                                        <ul class="post-meta pull-right">
                                            <li>Sent By:
                                             <?php if( $row->type_msg=="Admin"){ echo $row->username;}else{
                                    ...
                                    <div class="lower-box">
                                        <h3><strong>Subject: </strong><?php echo $row->subject ?></h3>
                                        <div class="text">
                                        	<p style="text-align: justify;"><?php echo $row->message ?><br />
                                            <br />   <?php if( $row->type_msg=="Admin"){ ?><strong>Regards,<br />
                                            <?php echo  "Crane Administration";}?>
                                           </strong></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="comments-area" style="display: none;">
                            <div class="group-title"><h2>Reply</h2></div>
                            <!-- Comment Form -->
                            ...
                            <div class="form-inner">
                                ...
                                <form method="post" action="#">
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                            <button class="theme-btn btn-style-two" type="submit" name="submit-form">Reply</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
