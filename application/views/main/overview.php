  <section class="page-title" style=  "background-image: url(<?php echo base_url('public/images/background/6.jpg'); ?>);">
    	<div class="auto-container">
        	<h1> Crane Overview </h1>
            <ul class="page-breadcrumb">
            	<li><a href="<?php echo base_url('') ?>">Home</a></li>
                <li>About Us</li>
                <li>Crane Overview</li>
            </ul>
        </div>
    </section>
    <!--End Page Title-->
                ...
                <div class="sidebar-side col-lg-3 col-md-4 col-sm-12 col-xs-12">
                	<aside class="sidebar default-sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <div class="image">
                            	<img src="<?php echo base_url('public/images/about/2.jpg') ?>" style="height: 250px;" />
                            </div><br />
                            <ul class="blog-cat">
                                <li><a href="<?php echo base_url('Maincontroller/About') ?>">Who We Are</a></li>
                            <li style="display: none;" class="active" ><a href="<?php echo
base_url('Maincontroller/Overview') ?>">Crane Overview</a></li>
                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                	<div class="company-single">
						<div class="inner-box">
                            <h3><span class="orange">CRANE</span> Overview</h3>
                            <div class="text">
                             <?php if ($result): ?> 
