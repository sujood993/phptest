                ...
                <div class="sidebar-side col-lg-3 col-md-4 col-sm-12 col-xs-12">
                	<aside class="sidebar default-sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <div class="image">
                            	<img src="<?php echo base_url('public/images/about/4.jpg') ?>" style="height: 250px;" />
                            </div><br />
                           <ul class="blog-cat">
...
base_url('Maincontroller/Overview') ?>">Crane Overview</a></li>
                            ...
                            <li class="active" ><a   href="<?php echo base_url('Maincontroller/TermsAndCondition') ?>">Terms and Condition</a></li>
